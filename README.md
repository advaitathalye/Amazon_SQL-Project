...
This project analyzes over 20,000 sales records from an Amazon platform to derive actionable insights into customer behavior, product performance, and sales trends. Using PostgreSQL, I tackled SQL problems such as revenue analysis, customer segmentation, and inventory management. The project includes data cleaning, handling null values, and solving real-world business problems through structured queries and stored procedures. An ERD diagram is provided to illustrate the database schema and table relationships visually.
```sql
